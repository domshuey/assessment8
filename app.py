...
def show_playlist(playlist_id):
    ...
    songs = [PlaylistSong.query.filter(PlaylistSong.playlist_id==playlist.id).all()]
...
def show_song(song_id):
    ...
    id = song.id
    in_playlist = [PlaylistSong.query.filter(PlaylistSong.song_id==id).all()]
    return render_template('song.html', song=song, in_playlist=in_playlist)
